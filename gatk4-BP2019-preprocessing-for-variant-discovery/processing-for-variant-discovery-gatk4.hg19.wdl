...
#  String bwa_commandline = select_first([bwa_commandline_override, "bwa mem -K 100000000 -p -v 3 -t 16 -Y $bash_ref_fasta"]) 
  String bwa_commandline = select_first([bwa_commandline_override, "bwa mem -p -v 3 -t 16 -Y $bash_ref_fasta"]) 
  Int compression_level
  
  String? gatk_docker_override
  String gatk_docker = select_first([gatk_docker_override, "/home/scientific/contrib/gatk:4.1.0.0"])
  String? gatk_path_override
  String gatk_path = select_first([gatk_path_override, "/home/scientific/contrib/gatk4/gatk"])

  String? gotc_docker_override
  String gotc_docker = select_first([gotc_docker_override, "/home/scientific/contrib/gatk:2.3.1-1512499786"])
  String? gotc_path_override
  String gotc_path = select_first([gotc_path_override, "/home/scientific/contrib/gatk4/"])

  String? python_docker_override
  String python_docker = select_first([python_docker_override, "/home/scientific/contrib/anaconda2/bin/python:2.7"])  
